...
namespace PemrClearingHouse.Api.Controllers
{
    ...
    public class InsuranceController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Insurance>> GetById(string id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Create(Insurance entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Update(string id, Insurance entity)
        {
